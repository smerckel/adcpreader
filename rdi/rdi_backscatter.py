...
class AcousticCrossSection(object):
    ...
    '''
    def __init__(self, k_t=1e-8, Nt=45, db_per_count=[0.3852]*4):
        self.__data=[k_t, Nt, db_per_count]
    ...
    def get_config(self, ens):
        ...
        Config = namedtuple('Config', field_names='k_t Nt db_per_count frequency beam_angle bin_size first_bin n_cells n_beams r'.split())
        k_t, Nt, db_per_count = self.__data
        config = Config(k_t, Nt, db_per_count, frequency, beam_angle,
